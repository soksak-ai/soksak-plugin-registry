...
서명한 뒤 self-verification을 수행하며 `registry-signed.json`만 게시합니다. Production private
seed는 GitHub Actions secret에만 존재하고 `registry-trust.json`과 Core에는 public trust root만
있습니다.

Trust rotation은 하나의 명시적인 작업입니다.
